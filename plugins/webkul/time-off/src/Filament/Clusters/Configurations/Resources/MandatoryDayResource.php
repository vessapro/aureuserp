...
class MandatoryDayResource extends Resource
{
    ...
    {
        return [
            __('time-off::filament/clusters/configurations/resources/mandatory-days.global-search.name')       => $record->name ?? '—',
            __('time-off::filament/clusters/configurations/resources/mandatory-days.global-search.start-date') => $record->start_date ?? '—',
            __('time-off::filament/clusters/configurations/resources/mandatory-days.global-search.end-date')   => $record->end_date ?? '—',
        ];
    }
