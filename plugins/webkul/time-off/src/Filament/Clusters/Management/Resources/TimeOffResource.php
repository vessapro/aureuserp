...
class TimeOffResource extends Resource
{
    ...
    public static function getGlobalSearchResultDetails(Model $record): array
    {
        return [
            ...
            __('time-off::filament/clusters/management/resources/time-off.global-search.request-date-from') => $record->request_date_from ?? '—',
            __('time-off::filament/clusters/management/resources/time-off.global-search.request-date-to')   => $record->request_date_to ?? '—',
        ];
    }
